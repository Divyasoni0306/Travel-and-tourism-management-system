...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        ...
        String[] text = new String[]{"JM Marriot Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The taj Hotel", "Happy Morning Motel", "River View Hotel"};
        try{
            for (int i =0; i<=9; i++){
